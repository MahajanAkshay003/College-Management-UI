    ...
    <Paper>
      <Table>
        <TableBody>
          ...
          <TableRow>
            <TableCell><Typography variant={"body2"} style={{ fontWeight: 500 }}>Prefix</Typography></TableCell>
            <TableCell>1696</TableCell>
          </TableRow>
          <TableRow>
            <TableCell><Typography variant={"body2"} style={{ fontWeight: 500 }}>Highest Education</Typography></TableCell>
